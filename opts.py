...
def parse_opt():
    ...
    parser.add_argument('--perss_onehot_h5', type=str, default='data/person_onehot_added1.h5',
                    help='path to the h5file containing the one hot of personality')
    ...
    parser.add_argument('--initialize_retrieval', type=str, default=None,
                    help="""xxxx.pth""")
    parser.add_argument('--use_joint',type=int,default=0,help='0 means no joint only generator, 1 means generator')
    parser.add_argument('--cached_tokens', type=str, default='person-train-idxs',
    ...
    parser.add_argument('--caption2_model', type=str, default="topdown",
                    help='show_tell, show_attend_tell, all_img, fc, att2in, att2in2, att2all2, adaatt, adaattmo, topdown, stackatt, denseatt, transformer')
    ...
    parser.add_argument('--label_smoothing', type=float, default=0,
                    help='')
    parser.add_argument('--use_dl', type=float, default=0,
                    help='')
    parser.add_argument('--use_sen', type=float, default=0,
                                    help='always backprop the largest loss to balance image and resnext')
    parser.add_argument('--use_sen2', type=float, default=0,
                                    help='always backprop the largest loss to balance image and resnext')
    
    parser.add_argument('--use_groupbn', type=float, default=0,
                                                   help='always backprop the largest loss to balance image and resnext')
